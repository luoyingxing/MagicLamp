    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateImageView.setBackgroundResource(R.mipmap.icon_pull_refresh_succeed);
                break;
            case FAIL:
            default:
                // 刷新失败
                ...
                refreshStateImageView.setBackgroundResource(R.mipmap.icon_pull_refresh_failed);
                break;
        }
        if (pullDownY > 0) {
            // 刷新结果停留0.5秒
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateImageView.setBackgroundResource(R.mipmap.icon_pull_load_succeed);
                break;
            case FAIL:
            default:
                // 加载失败
                ...
                loadStateImageView.setBackgroundResource(R.mipmap.icon_pull_load_failed);
                break;
        }
        if (pullUpY < 0) {
            // 刷新结果停留0.5秒
                ...
                if (mEvents == 0) {
                    if (pullDownY > 0
                        ...
                        if (state == REFRESHING) {
                            ...
                            || (((Pull) pullableView).canPullUp() && canPullUp && state != REFRESHING)) {
                        // 可以上拉，正在刷新时不能上拉
